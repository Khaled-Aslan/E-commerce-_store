                ...
                <>
                  {cartItem ? (
                    <div className="d-flex flex-column gap-3">
                      <div className="alert alert-success m-0 py-2 text-center rounded-3 fw-bold">
                        تمت إضافة المنتج إلى السلة!
                      </div>
                      <div className="d-flex align-items-center justify-content-between border rounded-pill p-1 bg-white">
                        <button
                      ...
                      <Link
                        to="/CheckOut"
                        className="btn w-100 py-2 fw-bold text-decoration-none text-center"
                        style={{
